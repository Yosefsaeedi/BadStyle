...
from BadStyle import BOT_USERNAME, dp
from BadStyle.config import get_bool_key
from BadStyle.modules.error import parse_update
from BadStyle.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("BadStyle.utils.filters." + module_name)
