...
from BadStyle.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/Yosefsaeedi/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/badstyle_channel"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/badstyle_chat"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add BadStyle to your group",
            url=f"https://telegram.me/BadStylebot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/BadStyleBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
