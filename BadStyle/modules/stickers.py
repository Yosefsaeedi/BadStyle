...
from BadStyle.services.events import register as Daisy
...
async def _(event):
    ...
    packshortname = f"BadStyle_stickers_{userid}"
    ...
    if is_a_s:
        ...
        packshortname = f"BadStyle_animated_{userid}"
