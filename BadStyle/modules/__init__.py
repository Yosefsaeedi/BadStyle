# Copyright (C) 2018 - 2020 yousefsaeedi. All rights reserved. Source code available under the AGPL.
# Copyright (C) 2021 BadStyle
# Copyright (C) 2020 yousefsaeedi
...
def list_all_modules() -> list:
    modules_directory = "BadStyle/modules"
