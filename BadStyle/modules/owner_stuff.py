...
from BadStyle import DAISY_VERSION, OWNER_ID, bot, dp
from BadStyle.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from BadStyle.modules import LOADED_MODULES
from BadStyle.services.mongo import db, mongodb
from BadStyle.services.redis import redis
...
async def restart_bot(message):
    ...
    args = [sys.executable, "-m", "BadStyle"]
